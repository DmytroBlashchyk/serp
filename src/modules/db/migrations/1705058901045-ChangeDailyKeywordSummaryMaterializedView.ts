...
export class ChangeDailyKeywordSummaryMaterializedView1705058901045
...
WHERE
    row_num = 1
GROUP BY
    keyword_id, date, url, exact_date)
select
    keywords.id AS keyword_id,
    COALESCE(result_position.max_position, 0)::FLOAT AS position,
    result_position.exact_date as position_date,
    result_position.url AS url,
    result_day1.max_position AS day1,
    result_day1.exact_date as day1_date,
    result_day7.max_position AS day7,
    result_day7.exact_date AS day7_date,
    result_day30.max_position AS day30,
    result_day30.exact_date AS day30_date,
    ...
    result_first_position.exact_date as first_position_date
from keywords
...
group by keywords.id,
         ...
         result_position.exact_date,
         result_position.url,
         result_day1.max_position,
         result_day1.exact_date,
         result_day7.max_position,
         result_day7.exact_date,
         result_day30.max_position,
         result_day30.exact_date,
         result_first_position.max_position,
         result_first_position.exact_date
      `);
  }
