...
@CommandHandler(CreateKeywordsForYoutubeCommand)
export class CreateKeywordsForYoutubeCommandHandler
  implements ICommandHandler<CreateKeywordsForYoutubeCommand>
{
  constructor(
  ...
  /**
   * Executes the CreateKeywordsForYoutubeCommand by performing keyword creation,
   * limiting updates, and scheduling relevant tasks based on provided command parameters.
   *
   * @param {CreateKeywordsForYoutubeCommand} command - The command containing necessary data for keyword creation and processing.
   * @return {Promise<void>} A promise that resolves when the command execution is complete.
   */
  async execute(command: CreateKeywordsForYoutubeCommand): Promise<void> {
    this.cliLoggingService.log('Start: CreateKeywordsForYoutubeCommandHandler');
    try {
  ...
  /**
   * Finds and returns the IDs from the first array that are not present in the objects of the second array.
   *
   * @param {IdType[]} ids - An array of ID values to be filtered.
   * @param {KeywordEntity[]} objects - An array of objects containing ID values.
   * @return {Promise<IdType[]>} A promise that resolves to an array of IDs that are not found in the second array.
   */
